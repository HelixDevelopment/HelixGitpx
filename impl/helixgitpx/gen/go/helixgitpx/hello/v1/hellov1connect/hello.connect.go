...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/helixgitpx/helixgitpx/gen/go/helixgitpx/hello/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HelloServiceName = "helixgitpx.hello.v1.HelloService"
)
...
const (
	...
	HelloServiceSayHelloProcedure = "/helixgitpx.hello.v1.HelloService/SayHello"
)

// HelloServiceClient is a client for the helixgitpx.hello.v1.HelloService service.
...
// NewHelloServiceClient constructs a client for the helixgitpx.hello.v1.HelloService service. By
...
func NewHelloServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HelloServiceClient {
	...
	helloServiceMethods := v1.File_helixgitpx_hello_v1_hello_proto.Services().ByName("HelloService").Methods()
...
// SayHello calls helixgitpx.hello.v1.HelloService.SayHello.
...
// HelloServiceHandler is an implementation of the helixgitpx.hello.v1.HelloService service.
...
func NewHelloServiceHandler(svc HelloServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/helixgitpx.hello.v1.HelloService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHelloServiceHandler) SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("helixgitpx.hello.v1.HelloService.SayHello is not implemented"))
}
